...
namespace QLNV
{
    public partial class Frm_NV : Form
    {
        ...
        public void tinhLuong()
        {
            ...
            {
              //  DateTime x = (row.Cells[dataGridView1.Columns["dNgaySinh"].Index].Value);
                row.Cells[dataGridView1.Columns["luong"].Index].Value = (DateTime.Now-(Convert.ToDateTime(row.Cells[dataGridView1.Columns["dNgaySinh"].Index].Value))) ;
            }
        }
